...
class COCOeval:
    ...
    def _prepare(self):
        ...
        # convert ground truth to mask if iouType == 'segm' or 'boundary'
        # note that in both cases, only masks will be converted since
        # boundaries are expected to be in rle format already!
