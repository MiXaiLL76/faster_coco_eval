...
def _make_bbox_eval(
    ...
    """Build a small bbox evaluator for core regression tests."""
    gt = COCO()
    gt.dataset = {
...
def test_math_matches_clears_annotations_before_a_second_run():
    ...
    run."""
    evaluator = _make_bbox_eval(detection_bbox=[0.0, 0.0, 8.0, 8.0])
...
def test_custom_summary_layout_matches_configured_ranges_and_max_dets():
    ...
    evaluator = _make_bbox_eval(ranges=ranges)
